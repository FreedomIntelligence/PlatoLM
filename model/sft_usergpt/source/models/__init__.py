...
from source.constants import DEFAULT_PAD_TOKEN, DEFAULT_BOS_TOKEN, DEFAULT_EOS_TOKEN, DEFAULT_UNK_TOKEN # , DEFAULT_EOC_TOKEN
...
def build_model(model_args, training_args):
    ...
    # if allow UserGPT learn the termination of conversations
    # smart_tokenizer_and_embedding_resize(
    #     special_tokens_dict=dict(sep_token=DEFAULT_EOC_TOKEN),
    #     tokenizer=tokenizer,
    #     model=model,
    #     )
